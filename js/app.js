...
const menuData = {
  coffee: [
    ...
    ["冰美式", "浓缩与冰水混合，清爽解暑，适合夏日午后。", "./img/menu-6.jpg", 22, "清爽", "冰饮", "经典"],
    ["燕麦拿铁", "燕麦奶替代牛奶，口感更轻盈，谷物香气明显。", "./img/menu-7.jpg", 30, "谷物", "轻盈", "推荐"],
    ["蜂蜜拿铁", "天然蜂蜜与浓缩融合，甜而不腻，适合秋冬。", "./img/menu-8.jpg", 32, "蜂蜜", "温润", "人气"],
  ],
  special: [
    ...
    ["蜜桃乌龙", "乌龙茶底搭配蜜桃果肉，清新鲜爽。", "./img/special-6.jpg", 32, "果香", "茶底", "季节"],
    ["薄荷冰咖", "薄荷清凉感与浓缩融合，醒神解暑。", "./img/special-7.jpg", 30, "薄荷", "冰饮", "限定"],
    ["摩卡星冰", "巧克力与咖啡层层叠加，顶部奶油轻盈。", "./img/special-8.jpg", 36, "巧克力", "奶盖", "热门"],
  ],
  bakery: [
    ...
    ["杏仁可颂", "杏仁片洒满可颂表面，烤制后酥香加倍。", "./img/bakery-6.jpg", 18, "坚果", "酥脆", "热卖"],
    ["曲奇饼干", "黄油曲奇搭配巧克力碎，酥松可口。", "./img/bakery-7.jpg", 12, "酥松", "经典", "甜点"],
    ["轻芝士蛋糕", "日式轻芝士工艺，入口即化，奶香柔和。", "./img/bakery-8.jpg", 24, "芝士", "绵密", "人气"],
  ],
};
...
const ambientMusic = (() => {
  ...
  return {
    ...
    start() {
      if (!audio || !audio.paused) return; // already playing or no element
      audio.play().catch(() => showToast("点击任意位置后再试"));
    },
